...
public class preguntadificil extends AppCompatActivity {
        ...
        aans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentQuestions < questionsitems.size() - 1) {
                    ...
                    Intent intent = new Intent(preguntadificil.this, Resultadofinal.class);
    ...
    private void loadAllQuestion() {
        ...
        String jsonquiz = loadJsonFromAsset("preguntasdificiles.json");
        try {
            JSONObject jsonObject = new JSONObject(jsonquiz);
            JSONArray questions = jsonObject.getJSONArray("preguntasdificiles");
